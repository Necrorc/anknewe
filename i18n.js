...
const TRANSLATIONS = {
  ru: {
    ...
    'cards.selectCardAria': 'Выбрать карточку',
    'cards.selectedCountLabel': 'Выбрано: {n} {noun}',
    'cards.clearSelectionBtn': 'Отмена',
    'cards.moveSelectedBtn': 'Перенести',
    'cards.moveModalTitle': 'Перенести {n} {noun}',
    'cards.moveModalHint': 'Прогресс (уровень, дата повторения) и теги перенесённых карточек сохранятся. Карточки, которые совпали бы со словом+переводом уже в целевой колоде, останутся на месте.',
    'cards.moveTargetLabel': 'В колоду',
    'cards.moveToNewDeckBtn': '+ Новая колода',
    'cards.moveConfirmBtn': 'Перенести',
    'cards.moveNoOtherDecks': 'Нет других колод — сначала создай новую',
    'cards.moveNoneMovedToast': 'Ничего не перенесено — все выбранные карточки уже есть в целевой колоде',
    'cards.moveDoneToast': 'Перенесено в «{name}»: {count} {noun}',
    'cards.moveSkippedSuffix': ', пропущено (уже есть в колоде): {skipped} {noun}',
    'cards.moveUndoneToast': 'Перенос отменён — карточки на месте',
  ...
  en: {
    ...
    'cards.selectCardAria': 'Select card',
    'cards.selectedCountLabel': 'Selected: {n} {noun}',
    'cards.clearSelectionBtn': 'Cancel',
    'cards.moveSelectedBtn': 'Move',
    'cards.moveModalTitle': 'Move {n} {noun}',
    'cards.moveModalHint': "The moved cards' progress (level, review date) and tags will be kept. Cards that would duplicate an existing word+translation pair in the target deck stay where they are.",
    'cards.moveTargetLabel': 'To deck',
    'cards.moveToNewDeckBtn': '+ New deck',
    'cards.moveConfirmBtn': 'Move',
    'cards.moveNoOtherDecks': 'No other decks yet — create one first',
    'cards.moveNoneMovedToast': 'Nothing moved — all selected cards already exist in the target deck',
    'cards.moveDoneToast': 'Moved to "{name}": {count} {noun}',
    'cards.moveSkippedSuffix': ', skipped (already in deck): {skipped} {noun}',
    'cards.moveUndoneToast': 'Move undone — cards are back',
  ...
  pl: {
    ...
    'cards.selectCardAria': 'Zaznacz fiszkę',
    'cards.selectedCountLabel': 'Zaznaczono: {n} {noun}',
    'cards.clearSelectionBtn': 'Anuluj',
    'cards.moveSelectedBtn': 'Przenieś',
    'cards.moveModalTitle': 'Przenieś {n} {noun}',
    'cards.moveModalHint': 'Postęp (poziom, data powtórki) i tagi przeniesionych fiszek zostaną zachowane. Fiszki, które powielałyby parę słowo+tłumaczenie już istniejącą w talii docelowej, pozostaną na miejscu.',
    'cards.moveTargetLabel': 'Do talii',
    'cards.moveToNewDeckBtn': '+ Nowa talia',
    'cards.moveConfirmBtn': 'Przenieś',
    'cards.moveNoOtherDecks': 'Nie ma innych talii — najpierw utwórz nową',
    'cards.moveNoneMovedToast': 'Nic nie przeniesiono — wszystkie zaznaczone fiszki już są w talii docelowej',
    'cards.moveDoneToast': 'Przeniesiono do „{name}”: {count} {noun}',
    'cards.moveSkippedSuffix': ', pominięto (już jest w talii): {skipped} {noun}',
    'cards.moveUndoneToast': 'Przeniesienie cofnięte — fiszki na miejscu',
